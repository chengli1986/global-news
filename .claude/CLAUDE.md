...
~60-source news digest system (57 RSS + 2 Sina API + 1 HN Firebase API; trial-promoted sources rotate ±1–2): fetches feeds in parallel, classifies articles via GPT-4.1-mini, generates categorized HTML email, sends 1x daily (12:15 BJT).

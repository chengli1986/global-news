...
40-source news digest system: fetches feeds in parallel, classifies articles via GPT-4.1-mini, generates categorized HTML email, sends 3x daily (BJT 08/16/00).
...
- `rss-health-check.py`: monitors all 40 sources every 6h, auto-swaps failed feeds after 3 consecutive failures
